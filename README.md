...
git clone https://github.com/<your-username>/plp-assignment-2.git
...
The repo includes test-webhook.js, a simple client script that POSTs a sample order payload.
Keep the server running in one terminal, then in a second terminal run:
